...
import { Flame, Bell, Search, Menu } from "lucide-react";
    ...
    <header className="h-20 bg-white/80 backdrop-blur-md border-b border-light-blue fixed top-0 right-0 left-0 lg:left-72 z-30 px-6">
      <div className="h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-6">
          <div className="flex items-center gap-2 bg-orange-50 text-orange-600 px-4 py-2 rounded-xl border border-orange-100 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[10px] font-bold text-primary-blue uppercase tracking-wider">
                {session?.user?.role === "admin" ? "Admin" : "Basic User"}
              </p>
            </div>
