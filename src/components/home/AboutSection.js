    ...
    <section id="about" className="relative px-5 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <Reveal direction="right" className="order-first flex items-center justify-center">
          ...
          <Reveal direction="left" className="space-y-8 text-center lg:order-last lg:text-left">
